...
int lineNumberTotal = 0;
    ...
    interface->Buttons[50].ScreenY = 240+180;
    ...
    {
        interface->Buttons[49].ScreenX = -999;
        interface->Buttons[49].ScreenY = -999;

        interface->Buttons[50].ScreenX = -999;
        interface->Buttons[50].ScreenY = -999;
